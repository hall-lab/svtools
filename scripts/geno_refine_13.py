...
vcf_rec = namedtuple ('vcf_rec', 'var_id sample svtype AF GT CN AB AS RS AP RP')
...
def load_df(var, exclude, sex):
    ...
    for s in var.sample_list:
        ...
        test_set.append(vcf_rec(var.var_id, s, var.info['SVTYPE'], var.info['AF'],
             var.genotype(s).get_format('GT'),  cn , var.genotype(s).get_format('AB'), var.genotype(s).get_format('AS'), 
             var.genotype(s).get_format('RS'), var.genotype(s).get_format('AP'), var.genotype(s).get_format('RP')))
