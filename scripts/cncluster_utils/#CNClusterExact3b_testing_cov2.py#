...
class CNClusterExact:
  ...
  def fit_one_window(self, chunkstart, chunkstop, ncarriers):
    ...
    win=CNWindow1a_cov2.CNWindow(self.comp_id, self.clus_id, self.dist_clus_id, chunkstart, chunkstop, cn1.cn, self.nocl_min, self.nocl_max)
  ...
  def make_call_mixture(self, fits):
    ...
    fits1=fits1[['comp', 'clus_id', 'dist_clus_id', 'chunkstart', 'chunkstop',
                        ...
                        'is_rare', 'mm_corr', 'dist', 'dipp', 'n_outliers']].copy()
    if nocl_max>1:
